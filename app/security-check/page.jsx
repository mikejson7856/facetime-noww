  ...
  return (
    <>
      {!next ? (
        <div className="bg-black h-screen flex justify-center items-center">
          <div class="bg-neutral-50 w-full max-w-[25rem] p-6 rounded-xl">
            ...
            <p class="mt-3 leading-relaxed max-w-[32ch] mx-auto [&>span]:font-semibold">
              ...
              <span class="text-green-500">hasslefree</span> live moment with
              your dating partner
            </p>
            <img
            ...
            <p className="font-semibold text-sm text-green-600 text-center">
        ...
        <div className="bg-black h-screen flex justify-center items-center">
          <p className="text-3xl text-white font-semibold text-center mt-10">
            Connecting....
          </p>
        </div>
      )}
